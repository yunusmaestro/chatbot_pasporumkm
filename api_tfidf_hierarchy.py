...
app = Flask(__name__)
CORS(app, origins=["https://pasporumkm.com"])
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', port=443, debug=True, ssl_context=('/etc/letsencrypt/live/pasporumkm.com/cert.pem', '/etc/letsencrypt/live/pasporumkm.com/privkey.pem'))
